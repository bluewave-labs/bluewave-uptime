...
const TeamPanel = () => {
  ...
  const GAP_SIZE = theme.spacing(12); 
  ...
  return (
    ...
    >
      <Stack component="form" noValidate spellCheck="false" gap={GAP_SIZE}> {}
      ...
      >
        <TextInput
          marginBottom={GAP_SIZE} // Applied GAP_SIZE for consistent spacing
          type="email"
