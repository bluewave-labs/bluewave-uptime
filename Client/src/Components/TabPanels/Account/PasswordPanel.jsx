...
const PasswordPanel = () => {
	...
	const SPACING_GAP = theme.spacing(13); // EDITED: Added a constant for gap size.
		...
		>
			...
			>
				...
				<Stack
					...
					alignItems={"center"}
					gap={SPACING_GAP} // EDITED: Replaced gap with SPACING_GAP constant
					flexWrap={"wrap"}
				>
					<Typography
						component="h1"
				...
				<Stack
					direction="row"
					alignItems={"center"}
					gap={SPACING_GAP} // Used a constant Gap size to show gap
					flexWrap={"wrap"}
				>
					<Typography
						component="h1"
