...
<div align="center">
  <!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="https://www.bluewavelabs.ca" style="height:40px; v-text-anchor:middle; width:98px;" arcsize="12.5%"  strokecolor="#7e8c8d" strokeweight="3px" fillcolor="#ffffff"><w:anchorlock/><center style="color:#000000;"><![endif]-->
    <a href="${loginUrl}" target="_blank" class="v-button" style="box-sizing: border-box;display: inline-block;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #000000; background-color: #ffffff; border-radius: 5px;-webkit-border-radius: 5px; -moz-border-radius: 5px; width:auto; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;border-top-width: 3px; border-top-style: solid; border-top-color: #7e8c8d; border-left-width: 3px; border-left-style: solid; border-left-color: #7e8c8d; border-right-width: 3px; border-right-style: solid; border-right-color: #7e8c8d; border-bottom-width: 3px; border-bottom-style: solid; border-bottom-color: #7e8c8d;font-size: 14px;">
